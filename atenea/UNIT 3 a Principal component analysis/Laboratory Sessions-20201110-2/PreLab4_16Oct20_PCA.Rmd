...
filepath<-"D:/Dropbox/DOCENCIA/FIB-ADEI/PRACTICA/NYCABS/LABS/"
...
lines(res.pca$quali.sup$coord[2:4,1],res.pca$quali.sup$coord[2:4,2],lwd=2,col="black")
...
lines(res.pca$quali.sup$coord[2:4,1],res.pca$quali.sup$coord[2:4,2],lwd=2,lty=2,col="black")
